...
interface ConsumableOrderDetailPageWrapperProps {
  children: ReactNode;
}

export default function ConsumableOrderDetailPageWrapper({ children }: ConsumableOrderDetailPageWrapperProps) {
  return (
    <PagePackageGate
