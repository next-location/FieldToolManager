...
interface NewMaintenanceRecordFormProps {
  equipment: Equipment[]
  currentUserName: string
  organizationId: string
}

export default function NewMaintenanceRecordForm({
  equipment,
  currentUserName,
  organizationId,
}: NewMaintenanceRecordFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 一覧画面へリダイレクト
      router.push('/equipment/maintenance-records')
      router.refresh()
    } catch (err: any) {
