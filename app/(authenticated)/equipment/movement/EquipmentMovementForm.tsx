            ...
            <div className="space-y-3">
              <div>
                ...
                >
                  ...
                  {locations.filter(loc => loc.is_own_location && loc.id !== selectedEquipment?.current_location_id).length > 0 && (
                    <optgroup label="━━ 自社拠点 ━━">
                      {locations.filter(loc => loc.is_own_location && loc.id !== selectedEquipment?.current_location_id).map((location) => (
