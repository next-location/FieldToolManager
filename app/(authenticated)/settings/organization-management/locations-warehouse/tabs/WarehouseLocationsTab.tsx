...
export default function WarehouseLocationsTab({ locations, organizationId }: WarehouseLocationsTabProps) {
  return (
    <div>
      <div className="mb-6 flex justify-between items-center">
        <div className="text-sm text-gray-600">
          登録位置数: <span className="font-semibold">{locations.length}</span>
        </div>
