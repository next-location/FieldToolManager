...
### ✅ テスト1: 月払い契約の請求書生成とメール送信

**目的:** 月払い契約で正しく請求書が生成され、メールが送信されることを確認
...
**確認項目:**
- [ ] Stripeに請求書が作成されている
- [ ] データベースのinvoicesテーブルに記録されている
- [ ] invoice_itemsに明細が保存されている
- [ ] 請求金額が正しい（基本料金 + 機能パック料金）
- [ ] 請求書PDFがメールで送信されている
- [ ] メールの件名・本文が正しい
- [ ] PDFの内容が正しい（組織名、金額、明細）
